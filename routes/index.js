...
router.get('/', function (req, res) {
  res.render('index', { title: 'Racecar App', user : req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'Racecar App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Racecar App Login', user : req.user });
});
